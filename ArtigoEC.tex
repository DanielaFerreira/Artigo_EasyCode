...
\par Existem alguns	 softwares que possibilitam	 a programação visual, como Duinoblocks (2014), Scratch (2013), CodeMonster (2014) e MicroBit (2016), veja tabela 1. Embora os softwares ofereceram recursos básicos da programação, eles não possuem conversão para multilinguagens como a ferramenta proposta possuirá. O Scratch baseia-se apenas na simulação, portanto, não há nenhum código-fonte gerado; CodeMonster, apesar de demonstrar o resultado do código-fonte produzido, conta com falha no armazenamento do progresso do aluno e na interação com o mesmo e, assim como os softwares MicroBit e DuinoBlocks, limita-se na conversão para apenas uma linguagem.

\begin{table}[htb!]
\caption{Tabela comparativa de \textit{softwares}.} 
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\multirow{2}{*}{Recursos}                                                                         & \multicolumn{5}{c|}{Softwares}                       \\ \cline{2-6}

                                                                                                  & Scratch & CodeMonster & MicroBit & DuinoBlocks & (?) \\ \hline
\begin{tabular}[c]{@{}c@{}}Armazenamento\\ do progresso\end{tabular}                              & Sim     & Não         & Sim      & Sim         & Sim \\ \hline
\begin{tabular}[c]{@{}c@{}}Conversão para uma \\ linguagem de \\ programação\end{tabular}         & Não     & Sim         & Sim      & Sim         & Sim \\ \hline
\begin{tabular}[c]{@{}c@{}}Conversão para mais \\ de uma linguagem de \\ programação\end{tabular} & Não     & Não         & Não      & Não         & Sim \\ \hline
\begin{tabular}[c]{@{}c@{}}Recursos básicos\\ de programação\end{tabular}                         & Sim     & Sim         & Sim      & Sim         & Sim \\ \hline
\end{tabular}
\end{table}
